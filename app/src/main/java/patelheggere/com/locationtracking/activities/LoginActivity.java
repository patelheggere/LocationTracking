...
import patelheggere.com.locationtracking.models.UserDetails;
...
import static patelheggere.com.locationtracking.helper.utility.FNAME;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(SharedPreferenceHelper.getInstance().get(isFirstTime, false))
        {
        ...
        if (shouldShowRequestPermissionRationale(ACCESS_COARSE_LOCATION))
        {
            Snackbar.make(mEmailView, R.string.permission_rationale, Snackbar.LENGTH_INDEFINITE)
                    .setAction(android.R.string.ok, new View.OnClickListener() {
                        ...
                        @TargetApi(Build.VERSION_CODES.M)
                        public void onClick(View v) {
                            requestPermissions(new String[]{ACCESS_COARSE_LOCATION}, REQUEST_READ_CONTACTS);
                        }
                    });
        } else {
            requestPermissions(new String[]{ACCESS_COARSE_LOCATION, }, REQUEST_READ_CONTACTS);
        ...
        if (cancel) {
            ...
            try {
                final JSONObject jsonBody = new JSONObject("{\"email\":"+email+", \"password\":" + password+" }");
                    SharedPreferenceHelper.getInstance().save("isFirstTime", true);
                    jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, LOGIN_URL, jsonBody, new Response.Listener<JSONObject>() {
                @Override
                public void onResponse(JSONObject response) {
                    UserDetails userDetails = new Gson().fromJson(response.toString(), UserDetails.class);
                    SharedPreferenceHelper.getInstance().save(FULL_NAME, userDetails.getName());
                    SharedPreferenceHelper.getInstance().save(UID, userDetails.getUid());
                    SharedPreferenceHelper.getInstance().save(EMAIL, userDetails.getEmail());
                    startActivity(new Intent(LoginActivity.this, MainActivity.class));
                }
